![דברו עם תוכניית דוקאביב 2026](assets/banner.jpeg)
...
קלוד יחזיר תכנית מסודרת עם שעות, אולמות, קישורים לעמוד כל סרט, וקישור ישיר להזמנת כרטיסים — ואם תרצו, גם הודעת וואטסאפ מוכנה להעתקה ושיתוף, עם שם הסרט, מועד ומיקום ההקרנה, תיאור של עד חמש מילים, קישור לעמוד הסרט וקישור להזמנה.
...
**טיפ:** אחרי שמתקינים את הסקיל במחשב, אפשר להמשיך את השיחה מהנייד — פשוט פתחו את אפליקציית Claude בטלפון והמשיכו מאותה שיחה.
